...
class IsthereanyclothesScrapySpiderMiddleware:
...
class IsthereanyclothesScrapyDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class RandomUserAgentMiddleware(object):
    ...
    def process_response(self, request, response, spider):
        # logger to check if user agent is random can be remove in production
